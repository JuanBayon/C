...
WorkspacePath          :=/media/sf_shared/PR3
ProjectPath            :=/media/sf_shared/PR3/UOCVaccine
...
$(OutputFile): $(Objects)
	...
	@$(MakeDirCommand) "/media/sf_shared/PR3/.build-debug"
	@echo rebuilt > "/media/sf_shared/PR3/.build-debug/UOCVaccine"

MakeIntermediateDirs:
	@test -d ../lib || $(MakeDirCommand) ../lib
...
$(IntermediateDirectory)/src_center.c$(ObjectSuffix): src/center.c $(IntermediateDirectory)/src_center.c$(DependSuffix)
	$(CC) $(SourceSwitch) "/media/sf_shared/PR3/UOCVaccine/src/center.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/src_center.c$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/src_date.c$(ObjectSuffix): src/date.c $(IntermediateDirectory)/src_date.c$(DependSuffix)
	$(CC) $(SourceSwitch) "/media/sf_shared/PR3/UOCVaccine/src/date.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/src_date.c$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/src_person.c$(ObjectSuffix): src/person.c $(IntermediateDirectory)/src_person.c$(DependSuffix)
	$(CC) $(SourceSwitch) "/media/sf_shared/PR3/UOCVaccine/src/person.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/src_person.c$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/src_vaccine.c$(ObjectSuffix): src/vaccine.c $(IntermediateDirectory)/src_vaccine.c$(DependSuffix)
	$(CC) $(SourceSwitch) "/media/sf_shared/PR3/UOCVaccine/src/vaccine.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/src_vaccine.c$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/src_appointment.c$(ObjectSuffix): src/appointment.c $(IntermediateDirectory)/src_appointment.c$(DependSuffix)
	$(CC) $(SourceSwitch) "/media/sf_shared/PR3/UOCVaccine/src/appointment.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/src_appointment.c$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/src_stock.c$(ObjectSuffix): src/stock.c $(IntermediateDirectory)/src_stock.c$(DependSuffix)
	$(CC) $(SourceSwitch) "/media/sf_shared/PR3/UOCVaccine/src/stock.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/src_stock.c$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/src_csv.c$(ObjectSuffix): src/csv.c $(IntermediateDirectory)/src_csv.c$(DependSuffix)
	$(CC) $(SourceSwitch) "/media/sf_shared/PR3/UOCVaccine/src/csv.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/src_csv.c$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/src_api.c$(ObjectSuffix): src/api.c $(IntermediateDirectory)/src_api.c$(DependSuffix)
	$(CC) $(SourceSwitch) "/media/sf_shared/PR3/UOCVaccine/src/api.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/src_api.c$(ObjectSuffix) $(IncludePath)
